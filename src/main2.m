...
D = 3;			% downsampling factor for LR
N_images = 4;   % number of LR images
U = 3;			% upsampling factor for SR
...
fprintf(' * registering ... \t\t\t\t');
tic
registration = register_images(ds_images);
...
us_images = interpolate_images2(ds_images,U,saveFlag,filename);
